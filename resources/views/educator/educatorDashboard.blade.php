        ...
        <div class="tab-content" id="setting-content">
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              ...
              <li class="list">
                <div class="profile"><img src="{{ asset ('assets/images/faces/face1.jpg') }}" alt="image"><span class="offline"></span></div>
                <div class="info">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="error">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/small-game/games.html"> Small Game </a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/quiz/quiz.php?sid="> Quiz </a></li>
